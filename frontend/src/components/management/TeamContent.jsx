  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <p className="text-muted-foreground">Управление тестировщиками и пользователями</p>
        </div>
        {permissions.isAdmin && (
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-muted-foreground">Активные (оплачиваемые)</CardTitle>
          </CardHeader>
          <CardContent>
