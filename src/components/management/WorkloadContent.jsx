...
import { Users, CheckCircle2, Clock, TrendingUp, AlertCircle, User } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <p className="text-muted-foreground">Загрузка команды и планирование ресурсов</p>
